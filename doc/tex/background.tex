...
The two most common used gateway types (figure~\ref{fig:bpmn-gateway-types}):
...
Components are shown on figure~\ref{fig:bpm-console}:
...
articats are described in table~\ref{tab:bpm-components}.
...
\item ProcessEnginePlugin: handles management of the process engine
\end{itemize}
